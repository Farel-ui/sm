    <!-- Navbar Wrapper -->
    <div id="navbar" class="sticky top-0 z-[9999] w-full h-20 flex items-center px-4 bg-transparent transition-all duration-300 ease-in-out">
    ...
    <li><a href="{{ route('implementasi') }}">Program Implementasi</a></li>
    <li><a href="{{ url('penilaian') }}">Hasil Penilaian</a></li>
    <li><a href="{{ url('/masterplano') }}">Dokumen</a></li>
