...
<body>  
  <div class="masterplan-box">
    <h2>PAPARAN</h2>
    <p>
        Paparan data adalah uraian atau penyajian data yang telah  dikumpulkan oleh peneliti melalui berbagai metode <BR> seperti observasi,wawancara, atau dokumentasi
    </p>
</div>
