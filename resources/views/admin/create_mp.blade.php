...
<body class="gradient-bg min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-6 fade-in">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">
                            ...
                            Welcome to Your Masterplan Dashboard
                        </h3>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl mt-6 card-hover fade-in border border-gray-100">
                    ...
                    <div class="p-8 bg-white">
                        <form method="POST" action="{{ route('masterplan.store') }}" enctype="multipart/form-data" class="space-y-8">
                            @csrf
                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" id="title" name="title"
                                           ...
                                           placeholder="Enter masterplan title">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const searchInput = document.querySelector('input[placeholder="Search masterplan..."]');
