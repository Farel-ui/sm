...
<head>
    ...
    <title>Edit Implementasi - Dashboard</title>
            ...
            <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <a href="{{ route('implementasi') }}" class="mr-4 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{ route('implementasi') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('implementasi') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600">
                                        Implementasi
                                    </a>
                                </div>
                            </li>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl mt-6 card-hover fade-in border border-gray-100">
                    ...
                    <div class="p-8 bg-white">
                        <form method="POST" action="{{ route('implementasi.update', $implementasi->id) }}" enctype="multipart/form-data" class="space-y-8">
                            @csrf
                            ...
                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" id="title" name="title"
                                           value="{{ old('title', $implementasi->title) }}"
                                           ...
                                           placeholder="Enter implementasi title" required>
                                    @error('title')
                                ...
                                <div class="lg:col-span-2 space-y-2">
                                    ...
                                    <div class="relative">
                                        <input type="file" id="file" name="file" accept=".pdf,.doc,.docx,.ppt,.pptx"
                                               class="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors text-gray-600">
                                    </div>
                                    <p class="text-xs text-gray-500 flex items-center">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        Leave empty to keep current file. Only document files are accepted. Max file size: 10MB
                                    </p>
                                    @error('file')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
