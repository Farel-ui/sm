  ...
  <section class="flex justify-center items-center px-3 md:px-9 py-6">
    <div class="w-full max-w-[75%] h-[60vh] bg-white rounded-lg shadow-lg flex flex-col">
      ...
      <div class="bg-blue-600 text-white px-6 py-4 rounded-t-lg flex justify-between items-center">
        ...
        <a href="{{ route('admin.implementasi') }}" class="text-white hover:text-gray-200 text-xl">&times;</a>
      </div>

      <!-- Form -->
      <form action="{{ route('implementasi.update', $implementasi->id) }}" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col">
        @csrf
        @method('PUT')
        ...
        <div class="flex-1 overflow-y-auto px-6 py-10 space-y-6">
            ...
            <div>
              ...
              <div class="flex items-center space-x-6 mt-2">
                <label class="inline-flex items-center">
                  <input type="radio" name="status" value="public" {{ old('status', $implementasi->status) == 'public' ? 'checked' : '' }} class="text-blue-600" required>
          ...
          <div>
            ...
            <div class="w-full max-w-[100%] h-[82,5 vh] border-2 border-dashed border-gray-300 rounded-lg p-8 text-center justify-center flex flex-col items-center">
              ...
              <div id="currentFile" class="mt-3">
                <p class="text-sm text-blue-600">File saat ini: {{ $implementasi->file }}</p>
              </div>
              @endif
            </div>
          </div>
        ...
        <div class="px-6 py-4 border-t flex justify-end space-x-4">
          <a href="{{ route('admin.implementasi') }}"
