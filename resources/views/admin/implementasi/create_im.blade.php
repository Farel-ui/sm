      ...
      <form action="{{ route('admin.implementasi.store') }}" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-10 space-y-6">
          ...
          <div>
            ...
            <div class="w-full max-w-[100%] h-[30vh] border-2 border-dashed border-gray-300 rounded-lg p-8 text-center justify-center flex flex-col items-center transition-colors">
