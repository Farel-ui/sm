...
<head>
  ...
  <title>Tambah Implementasi</title>
...
<div class="flex justify-center px-3 md:px-9 ml-64">
  ...
  <section class="flex justify-center items-center px-3 md:px-9 py-6 ml-64">
    <div class="w-full max-w-[90%] h-[70vh] bg-white rounded-lg shadow-lg flex flex-col">
      <!-- Card Header -->
      ...
      <!-- Form -->
      <form action="{{ route('admin.implementasi.store') }}" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col">
        @csrf
        ...
        <div class="flex-1 overflow-y-auto px-6 py-10 space-y-6">
          ...
          <div>
            ...
            <div class="w-full max-w-[100%] h-[30vh] border-2 border-dashed border-gray-300 rounded-lg p-8 text-center justify-center flex flex-col items-center transition-colors file-input">
