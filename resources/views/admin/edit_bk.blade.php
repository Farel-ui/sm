...
<head>
    ...
    <title>Edit Booklet - Dashboard</title>
            ...
            <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <a href="{{ route('booklet') }}" class="mr-4 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{ route('booklet') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('booklet') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600">
                                        Booklet
                                    </a>
                                </div>
                            </li>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl mt-6 card-hover fade-in border border-gray-100">
                    ...
                    <div class="p-8 bg-white">
                        <form method="POST" action="{{ route('booklet.update', $booklet->id) }}" enctype="multipart/form-data" class="space-y-8">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-gray-500">Update the title of your booklet</p>
                                    @error('title')
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="file" id="file" name="file"
                                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 input-focus transition-all bg-white text-gray-800 placeholder-gray-400"
                                           accept=".pdf">
                                    <p class="text-xs text-gray-500">Upload a new PDF file for this booklet (optional)</p>
                                    @error('file')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="file" id="image" name="image"
                                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 input-focus transition-all bg-white text-gray-800 placeholder-gray-400"
                                           accept="image/*">
                                    <p class="text-xs text-gray-500">Upload a new image for this booklet (optional)</p>
                                    @error('image')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                ...
                <div class="mt-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 fade-in">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">Informasi Booklet</h3>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                                <div>
                                    <span class="font-medium">Dibuat:</span>
                                    {{ isset($booklet->created_at) ? $booklet->created_at->format('d M Y H:i') : 'N/A' }}
                                </div>
                                <div>
                                    <span class="font-medium">Diupdate:</span>
                                    {{ isset($booklet->updated_at) ? $booklet->updated_at->format('d M Y H:i') : 'N/A' }}
                                </div>
                                <div>
