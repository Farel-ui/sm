...
<body class="gradient-bg min-h-screen">
    ...
    <main class="pb-12 ml-64">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-xl">Dashboard Dimensi Smart City</span>
        </div>
        <!-- Kanan -->
                        ...
                        <tbody class="bg-white divide-y divide-blue-500">
                            @if(isset($dimensions) && $dimensions->count() > 0)
                                ...
                                <tr class="table-row hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
    @if ($dm->video && file_exists(public_path('storage/dimension/' . $dm->video)))
        <video width="120"
               height="80"
               controls
               preload="metadata"
    ...
    @endif
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ asset('storage/dimension/' . $dm->video) }}"
                                               class="action-btn bg-blue-500 text-white hover:text-yellow-400" title="Lihat">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.dimension.edit', $dm->id ?? '#') }}"
                                            ...
                                            <form id="delete-form-{{ $dm->id }}"
                                                  action="{{ route('admin.dimension.destroy', $dm->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-blue-500 mb-2">Belum ada dimension</h3>
                                            <p class="text-blue-500 mb-4">Mulai dengan menambahkan dimension pertama Anda</p>
                                            <a href="{{ route('admin.dimension.create') }}"
