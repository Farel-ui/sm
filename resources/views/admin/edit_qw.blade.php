...
<head>
    ...
    <title>Edit Data Quick Wins</title>
...
<body class="bg-blue-100 min-h-screen font-sans">
  ...
  <section class="flex justify-center items-center px-3 md:px-9 py-10">
    <div class="w-full max-w-[75%] h-[82,5vh] bg-white rounded-lg shadow-lg">
      <!-- Header -->
      ...
      <!-- Form -->
      <form action="{{ route('quickwin.update', $quickwin->id) }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6">
        @csrf
        @method('PUT')
          ...
          <div class="flex items-center space-x-6">
            <label class="inline-flex items-center">
              <input type="radio" name="status" value="public" class="text-blue-600"
                {{ old('status', $quickwin->status) === 'public' ? 'checked' : '' }} />
