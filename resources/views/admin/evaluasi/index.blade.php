                            ...
                            @if(isset($evaluasis) && $evaluasis->count() > 0)
                                ...
                                <tr class="table-row border-b border-blue-500 hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-blue-400"><i class="fas fa-chart-line mr-1"></i>Evaluasi Data</div>
                                    </td>

                                    <!-- Baseline -->
                                    <td class="px-6 py-4 text-center text-sm text-blue-700">
                                        <i class="fas fa-chart-bar mr-1"></i>
                                        {{ $evaluasi->baseline ?? 'N/A' }}
                                    </td>
                                ...
                                <tr>
                                    <td colspan="9" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-blue-500 mb-2">Belum ada evaluasi</h3>
                                            <p class="text-blue-500 mb-4">Mulai dengan menambahkan evaluasi pertama Anda</p>
