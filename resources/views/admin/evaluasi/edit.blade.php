        ...
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-600 text-white flex justify-between items-center px-6 py-6 rounded-lg shadow-md">
                ...
                <div class="flex items-center space-x-2">
                    <i class="fas fa-edit text-3xl mr-2"></i>
                    <span class="font-semibold text-xl">Edit Evaluasi</span>
                </div>
                <!-- Kanan -->
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl mt-6 card-hover fade-in border border-blue-100">
                <form action="{{ route('admin.evaluasi.update', $evaluasi->id) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label for="tahun" class="form-label">
                                <i class="fas fa-calendar mr-2 text-blue-500"></i>Tahun Evaluasi
                            </label>
                            <input type="number" id="tahun" name="tahun" value="{{ old('tahun', $evaluasi->tahun) }}"
                                   class="form-input w-full @error('tahun') border-red-500 @enderror"
                                   placeholder="Masukkan tahun evaluasi" min="2000" max="2100" required>
                            @error('tahun')
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" id="baseline" name="baseline" value="{{ old('baseline', $evaluasi->baseline) }}"
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" id="output" name="output" value="{{ old('output', $evaluasi->output) }}"
                                   class="form-input w-full @error('output') border-red-500 @enderror"
                                   placeholder="Masukkan nilai output">
                            @error('output')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" id="outcome" name="outcome" value="{{ old('outcome', $evaluasi->outcome) }}"
                                   class="form-input w-full @error('outcome') border-red-500 @enderror"
                                   placeholder="Masukkan nilai outcome">
                            @error('outcome')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" id="impact" name="impact" value="{{ old('impact', $evaluasi->impact) }}"
                                   class="form-input w-full @error('impact') border-red-500 @enderror"
                                   placeholder="Masukkan nilai impact">
                            @error('impact')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="number" step="0.01" id="quick_wins" name="quick_wins" value="{{ old('quick_wins', $evaluasi->quick_wins) }}"
                                   class="form-input w-full @error('quick_wins') border-red-500 @enderror"
                                   placeholder="Masukkan nilai quick wins">
                            @error('quick_wins')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
