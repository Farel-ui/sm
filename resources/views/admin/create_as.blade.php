...
<body class="gradient-bg min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-6 fade-in">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-6">
                        ...
                        <p class="text-gray-600">Create and manage your assessments efficiently with our streamlined interface.</p>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" id="color" name="color"
                                           ...
                                           placeholder="Enter assessment color">
                                    <p class="text-xs text-gray-500">Specify the color for this assessment</p>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const searchInput = document.querySelector('input[placeholder="Search assessment..."]');
