        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-600 text-white flex justify-between items-center px-6 py-6 rounded-lg shadow-md">
                ...
                <div class="flex items-center space-x-2">
                    <i class="fas fa-user-edit text-3xl mr-2"></i>
                    <span class="font-semibold text-xl">Edit User</span>
                </div>
                <!-- Kanan -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="password" class="form-label">
                                <i class="fas fa-lock mr-2 text-blue-500"></i>Password Baru (Opsional)
                            </label>
                        ...
                        <div class="md:col-span-2">
                            <label class="form-label">
                                <i class="fas fa-image mr-2 text-blue-500"></i>Avatar Saat Ini
                            </label>
                            <div class="current-avatar">
                                ...
                                @else
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-600">Tidak ada avatar</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <label for="avatar" class="form-label">
                                <i class="fas fa-image mr-2 text-blue-500"></i>Ubah Avatar (Opsional)
                            </label>
                            <div class="file-input" id="file-drop-zone">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-600">Klik untuk memilih gambar baru atau seret ke sini</p>
