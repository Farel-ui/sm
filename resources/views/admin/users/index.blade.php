...
<body class="bg-blue-50 min-h-screen font-sans">
    <main class="pb-12 ml-64">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-xl">Dashboard Users</span>
        </div>
        <!-- Kanan -->
                ...
                <div class="px-6 py-5 table-header">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="{{ route('admin.users.create') }}" class="btn-gradient  rounded-4xl">
                        ...
                        <tbody class="bg-white">
                            @if(isset($users) && $users->count() > 0)
                                ...
                                <tr class="table-row border-b border-blue-500 hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    <!-- No -->
                                    <td class="px-6 py-4 text-sm text-blue-500">{{ $index + $users->firstItem() }}</td>

                                    <!-- Name -->
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-semibold text-blue-600 searchable-title">{{ $user->name }}</div>
                                        <div class="text-xs text-blue-400"><i class="fas fa-user mr-1"></i>User Account</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @if($user->avatar)
                                            <div class="w-12 h-12 rounded-full overflow-hidden mx-auto">
                                                <img src="{{ asset('images/avatar/' . $user->avatar) }}" alt="Avatar" class="w-full h-full object-cover">
                                            </div>
                                        @else
                                            <div class="w-12 h-12 rounded-full bg-gray-200 mx-auto flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ route('admin.users.edit', $user->id) }}?page={{ request('page', $users->currentPage()) }}"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-blue-500 mb-2">Belum ada users</h3>
                                            <p class="text-blue-500 mb-4">Mulai dengan menambahkan user pertama Anda</p>
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-blue-500 flex items-center">
                    ...
                    Menampilkan <span class="font-medium mx-1">{{ $users->firstItem() }}</span>
                    - <span class="font-medium mx-1">{{ $users->lastItem() }}</span>
                    dari <span class="font-medium mx-1">{{ $users->total() }}</span> hasil
                </p>
            </div>
            <div>
