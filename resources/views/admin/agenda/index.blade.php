...
<body class="bg-blue-50 min-h-screen font-sans">
    <main class="pb-12 ml-64">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-xl">Dashboard Agenda Smart City</span>
        </div>
        <!-- Kanan -->
                ...
                <div class="px-6 py-5 table-header">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="{{ route('admin.agenda.create') }}" class="btn-gradient  rounded-4xl">
                        ...
                        <tbody class="bg-white">
                            @if(isset($agendas) && $agendas->count() > 0)
                                ...
                                <tr class="table-row border-b border-blue-500 hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    <!-- No -->
                                    <td class="px-6 py-4 text-sm text-blue-500">{{ $index + $agendas->firstItem() }}</td>

                                    <!-- Judul -->
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-semibold text-blue-600 searchable-title">{{ $agenda->judul }}</div>
                                        <div class="text-xs text-blue-400"><i class="fas fa-calendar mr-1"></i>Agenda Event</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ route('admin.agenda.edit', $agenda->id) }}?page={{ request('page', $agendas->currentPage()) }}"
                                    ...
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                                                <i class="fas fa-calendar-times text-blue-300 text-2xl"></i>
                                            </div>
                                            <h3 class="text-lg font-medium text-blue-500 mb-2">Belum ada agenda</h3>
                                            <p class="text-blue-500 mb-4">Mulai dengan menambahkan agenda pertama Anda</p>
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-blue-500 flex items-center">
                    ...
                    Menampilkan <span class="font-medium mx-1">{{ $agendas->firstItem() }}</span>
                    - <span class="font-medium mx-1">{{ $agendas->lastItem() }}</span>
                    dari <span class="font-medium mx-1">{{ $agendas->total() }}</span> hasil
                </p>
            </div>
            <div>
