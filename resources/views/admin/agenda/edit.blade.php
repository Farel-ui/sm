        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-600 text-white flex justify-between items-center px-6 py-6 rounded-lg shadow-md">
                ...
                <div class="flex items-center space-x-2">
                    <i class="fas fa-calendar-plus text-3xl mr-2"></i>
                    <span class="font-semibold text-xl">Edit Agenda</span>
                </div>
                <!-- Kanan -->
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl mt-6 card-hover fade-in border border-blue-100">
                <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="judul" name="judul" value="{{ old('judul', $agenda->judul) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="date" id="tanggal" name="tanggal" value="{{ old('tanggal', $agenda->tanggal) }}"
