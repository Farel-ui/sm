...
<body class="gradient-bg min-h-screen">
    ...
    <main class="pb-12 ml-64">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-xl">Dashboard Booklet Smart City</span>
        </div>
        <!-- Kanan -->
                                ...
                                <tr class="table-row hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ asset('storage/booklet/' . $bk->image) }}" target="_blank"
                                               class="action-btn bg-blue-500 text-white hover:text-yellow-400" title="Lihat">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.booklet.edit', $bk->id ?? '#') }}"
                                            ...
                                            <!-- Form hapus (hidden) -->
                                            <form id="delete-form-{{ $bk->id }}"
                                                  action="{{ route('admin.booklet.destroy', $bk->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
