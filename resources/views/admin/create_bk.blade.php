...
<body class="bg-blue-100 min-h-screen font-sans">
  ...
  <section class="flex justify-center items-center px-3 md:px-9 py-6">
    <div class="w-full max-w-[75%] h-[82,5vh] bg-white rounded-lg shadow-lg flex flex-col">
      ...
      <!-- Form -->
      <form action="{{ route('booklet.store') }}" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col">
        @csrf
        ...
        <div class="flex-1 overflow-y-auto px-6 py-10 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div id="uploadContainer" class="w-full h-[10vh] border-2 border-dashed border-gray-300 rounded-lg p-8 text-center flex flex-col items-center justify-center transition-colors cursor-pointer">
                ...
                <div id="uploadArea" class="flex flex-col items-center justify-center w-full h-full">
                  ...
                  <p class="text-gray-500 text-sm">Klik untuk mengunggah gambar</p>
                </div>
