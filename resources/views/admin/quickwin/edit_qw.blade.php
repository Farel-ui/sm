        ...
        <section class="flex justify-center items-center px-3 md:px-9 py-6 ml-64">
            <div class="w-full max-w-[90%] bg-white rounded-lg shadow-lg">
                ...
                <form action="{{ route('admin.quickwin.update', $quickwin->id) }}" method="POST" enctype="multipart/form-data" class="px-6 py-6 space-y-6">
                    ...
                    <!-- Grid: Judul & Upload Gambar -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Judul -->
                        <div>
                            <label class="block text-sm font-semibold mb-2">JUDUL</label>
                            <input type="text" name="title" value="{{ old('title', $quickwin->title) }}"
                        ...
                        <div>
                            ...
                            <div class="file-input w-full border border-gray-400 rounded-md px-3 py-4 text-center cursor-pointer">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="6" placeholder="Tulis deskripsi di sini..." required
                                  class="w-full border border-gray-400 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description', $quickwin->description) }}</textarea>
                    </div>
