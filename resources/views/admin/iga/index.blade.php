...
<body class="gradient-bg min-h-screen">
    ...
    <main class="pb-12 ml-64">
        ...
        <div class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-xl">Dashboard IGA Smart City</span>
        </div>
        <!-- Kanan -->
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Cari iga..." id="searchInput"
                            ...
                            @if(isset($iga) && $iga->count() > 0)
                                ...
                                <tr class="table-row hover:bg-blue-50 transition-all duration-200 searchable-row">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="px-3 py-1 rounded-full text-xs font-medium {{ $ig->status == 'publish' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }}">
                                            {{ ucfirst($ig->status) }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <a href="{{ route('admin.iga.edit', $ig->id ?? '#') }}"
                                            ...
                                            <!-- Form hapus (hidden) -->
                                            <form id="delete-form-{{ $ig->id }}"
                                                  action="{{ route('admin.iga.destroy', $ig->id) }}"
                                                  method="POST"
                                                  style="display:none;">
                                                @csrf
                                                @method('DELETE')
